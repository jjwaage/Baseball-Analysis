...
Wins above replacement (WAR) is a statistic used to show how many more wins a player is worth than a replacement level player at the same position, such as a free agent of a minor league player. The way to calculate it is different for position players and pitchers.
