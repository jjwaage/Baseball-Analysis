...
names(graphal) <- c("TB", "BAL", "NYY", "TOR", "BOS")
...
names(graphalc) <- c("CWS", "CLE", "DET", "KAN", "MIN")
...
names(graphalw) <- c("HOU", "LAA", "OAK", "SEA", "TEX")
...
names(graphnle) <- c("ATL", "MIA", "NYM", "PHI", "WAS")
...
names(graphnlc) <- c("CHC", "CIN", "MIL", "PIT", "STL")
...
names(graphnlw) <- c("ARI", "COL", "LAD", "SD", "SF")
