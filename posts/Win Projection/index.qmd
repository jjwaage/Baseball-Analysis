...
plot(data, cex = 0.5, pch = 16, xlab = "Projected Chance of Making Playoffs", ylab = "Chances of Making 2023 Playoffs", col = "blue")
abline(lm(realplayoffperc ~ playoffperc), col = "red")

```

The slope from this regression line is r = 0.82592 and 
```{r}
expression("R"^"2")
```
